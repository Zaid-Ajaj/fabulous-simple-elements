...
let [<Literal>] ClearPlaceholderCommandParameter = "ClearPlaceholderCommandParameter"
...
let [<Literal>] CommandParameter = "CommandParameter"
let [<Literal>] DisplayMemberName = "DisplayMemberName"
...
let [<Literal>] IsFocused = "IsFocused"
let [<Literal>] Keyboard = "Keyboard"
let [<Literal>] PlaceholderColor = "PlaceholderColor"
let [<Literal>] FocusChangeRequested = "FocusChangeRequested"
...
let [<Literal>] SelectionChangedCommand = "SelectionChangedCommand"
...
let [<Literal>] ScrollToRequested = "ScrollToRequested"
let [<Literal>] ScrollTo = "ScrollTo"