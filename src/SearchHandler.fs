...
let ClearPlaceholderCommandParameter (value: obj) = createProp Keys.ClearPlaceholderCommandParameter value
...
let CommandParameter (value: obj) = createProp Keys.CommandParameter value
let DisplayMemberName (value: string) = createProp Keys.DisplayMemberName value
...
let IsFocused (condition: bool) = createProp Keys.IsFocused condition
...
let FocusChangeRequested (f: VisualElement.FocusRequestArgs -> unit) = createProp Keys.FocusChangeRequested f
...
let inline searchHandler (props: ISearchHandlerProp list) : ViewElement =
    ...
    View.SearchHandler(
        ...
        ?clearPlaceholderCommandParameter = find Keys.ClearPlaceholderCommandParameter,
        ...
        ?commandParameter = find Keys.CommandParameter,
        ?displayMemberName = find Keys.DisplayMemberName,
        ...
        ?focusChangeRequested = find Keys.FocusChangeRequested,
